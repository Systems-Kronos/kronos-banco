...
INSERT INTO public.Tarefa (nCdTarefa, cNmTarefa, nCdUsuarioRelator, nCdHabilidade, iGravidade, iUrgencia, iTendencia, nTempoEstimado, cDescricao, cStatus) VALUES
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Desenvolver API de Autenticação', 1, 1, 5, 4, 5, 80.0, 'Criar uma API REST para o sistema de autenticação.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Otimizar Query de Relatórios', 1, 2, 4, 5, 4, 25.5, 'Revisar e otimizar a consulta para o dashboard principal.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Planejar Sprint 3', 1, 3, 3, 3, 4, 15.0, 'Definir as tarefas e estimativas para a próxima sprint.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Campanha de E-mail de Natal', 2, 4, 5, 4, 5, 40.0, 'Criar e executar campanha de e-mail marketing para o final do ano.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Revisão de Código do Módulo Financeiro', 1, 1, 5, 2, 4, 10.0, 'Revisar o código do módulo financeiro em busca de bugs.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Auditoria Interna de Receitas', 3, 7, 4, 4, 4, 50.0, 'Conduzir uma auditoria completa das receitas do último trimestre.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Organizar Fluxo de Armazém', 4, 9, 3, 3, 5, 30.0, 'Reorganizar o layout do armazém para otimizar o fluxo de trabalho.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Proposta de Imposto Simplificado', 3, 7, 2, 3, 2, 20.0, 'Elaborar uma proposta para adesão ao Simples Nacional.', 'Cancelada'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Treinamento de Equipe em Marketing de Conteúdo', 2, 5, 3, 2, 4, 12.0, 'Criar e ministrar um treinamento sobre novas técnicas de criação de conteúdo.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Configurar Servidores AWS', 1, 23, 5, 5, 5, 20.0, 'Subir novos servidores e configurar ambientes na AWS.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Desenvolvimento de Módulo de Pedidos', 5, 10, 4, 3, 5, 45.0, 'Programar o módulo de pedidos para o novo sistema.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Análise de Tráfego do Site', 5, 11, 3, 4, 4, 15.0, 'Analisar o tráfego do site e identificar vulnerabilidades.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Criação de Logo para Campanha', 6, 12, 5, 4, 5, 10.0, 'Desenhar um novo logo para a campanha de lançamento.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Teste de Usabilidade do App', 6, 13, 4, 3, 4, 20.0, 'Realizar testes com usuários para validar a usabilidade do aplicativo.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Revisão de Processo de Produção', 7, 14, 3, 5, 4, 35.0, 'Auditar o processo de produção para garantir a qualidade.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Inventário da Cadeia de Suprimentos', 7, 15, 4, 4, 3, 25.0, 'Contar e registrar todos os produtos no estoque.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Otimização de SEO para Produtos', 8, 16, 5, 2, 5, 18.0, 'Melhorar as descrições dos produtos para otimização de busca.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Fluxo de Devoluções', 8, 17, 3, 3, 4, 12.0, 'Criar um processo de devolução mais eficiente.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Treinamento de Atendimento ao Cliente', 9, 18, 2, 1, 3, 8.0, 'Ministrar treinamento para a nova equipe de suporte.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Digitalizar prontuários médicos', 9, 19, 4, 4, 5, 50.0, 'Converter prontuários físicos para o formato digital.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Plano de plantio para o próximo semestre', 10, 20, 5, 5, 5, 60.0, 'Desenvolver o plano de plantio com base em previsões climáticas.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Criação de Pastagem para Gado', 10, 21, 3, 2, 4, 25.0, 'Preparar nova área para pastagem do rebanho.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Desenvolver front-end do dashboard', 1, 1, 5, 4, 5, 70.0, 'Implementar a interface do usuário para o dashboard principal.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Criar relatório de performance de marketing', 2, 4, 4, 5, 4, 30.0, 'Gerar relatório mensal de performance das campanhas.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Revisar balanço trimestral', 3, 6, 5, 5, 4, 45.0, 'Conferir e validar o balanço patrimonial.', 'Em Andamento'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Otimização de rotas de entrega', 4, 8, 4, 5, 5, 20.0, 'Calcular e aplicar novas rotas para a frota.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Atualização de código', 5, 10, 3, 2, 3, 15.0, 'Aplicar patches e atualizações de segurança.', 'Concluída'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Analise de mercado', 8, 16, 3, 3, 2, 16.0, 'Realizar pesquisa e análise da concorrência.', 'Pendente'),
                                                                                                                                                               (nextval('public.sq_tarefa'), 'Plano de expansão de mercado', 2, 4, 5, 4, 5, 30.0, 'Definir plano de expansão de mercado para o próximo ano.', 'Em Andamento');
